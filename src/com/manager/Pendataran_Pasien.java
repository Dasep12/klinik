...
public class Pendataran_Pasien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Report Pendaftaran Pasien", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
      ...
      //  String tgl1 = format1.format(tgl_awal.getDate());
       // String tgl2 = format1.format(tgl_akhir.getDate());
        ...
        try {
            ...
            String path  = "C://Backup File//Laporan Pendaftaran Pasien.pdf" ;
       ...
       // Cell cell = new PDf;
        ...
        table_cell2 = new PdfPCell(new Phrase("Tanggal Berobat",F));
        table_cell2.setBackgroundColor(BaseColor.BLUE);
        my_report_table.addCell(table_cell2);
        
        
        table_cell2 = new PdfPCell(new Phrase("Alamat",F));
        table_cell2.setBackgroundColor(BaseColor.BLUE);
        my_report_table.addCell(table_cell2);
        
        table_cell2 = new PdfPCell(new Phrase("No Telp",F));
        table_cell2.setBackgroundColor(BaseColor.BLUE);
        my_report_table.addCell(table_cell2);
        
        table_cell2 = new PdfPCell(new Phrase("No BPJS",F));
        table_cell2.setBackgroundColor(BaseColor.BLUE);
        my_report_table.addCell(table_cell2);
        ...
        while (res.next()) {                
            ...
            String makanan         = res.getString("alamat");
            table_cell          = new PdfPCell(new Phrase(makanan , F2));
            my_report_table.addCell(table_cell); 
            
            
            String notelp         = res.getString("no_telp");
            table_cell          = new PdfPCell(new Phrase(notelp , F2));
            my_report_table.addCell(table_cell);
            
            
            String bpjs         = res.getString("no_bpjs");
            table_cell          = new PdfPCell(new Phrase(bpjs , F2));
            my_report_table.addCell(table_cell);
         }
